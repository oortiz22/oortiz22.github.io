        ...
        for (let i = event.resultIndex, len = event.results.length; i < len; i++) {
            ...
            if (event.results[i].isFinal) {
                ...
                if (transcript.includes('play as white') || transcript.includes('i want to play white')
                    ...
                    console.log("pieceMove:",pieceMove);
                ...
                else if(transcript.includes('castle right') || transcript.includes('short castle') || transcript.includes('right castle')){
                    if(currentColor == 'w'){
                        let pieceMove = ' e1g1';
                        var please = extractCharNumCharNum(pieceMove);
                        makeMove(please);
                ...
                else if(transcript.includes('castle left') || transcript.includes('long castle') || transcript.includes('left castle') ){
                    if(currentColor == 'w'){
                        let pieceMove = ' e1c1';
                        var please = extractCharNumCharNum(pieceMove);
                        makeMove(please);
